-- this is a fork of Beacon Overhaul by notnotmelon
-- source: https://mods.factorio.com/mod/beacon-overhaul
-- changes: productivity beacon is removed, area of regular beacon is +2, module slot is doubled (4) and new graphics are used, nothing else
...
local function setup()
  global.overloaded_machines = global.overloaded_machines or {}
  global.beacon_tiles = global.beacon_tiles or {}
end
